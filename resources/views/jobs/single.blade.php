          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Vacancy:</strong>  {{$job->vacncy}}</li>
...
<li class="mb-2"><a  class ="text docoration-none" href="{{route ('categories.single', $category ->name)}}"> {{ $category-> name }}({{ $category-> total }})</a></li>
